...
func CreateDeck(c *gin.Context) {
	...
	if deckCode == "" {
		deckCode = deckcode.BuildDefaultDeckCode(req.MainFaction, req.AllyFaction)
	}
	deckCode = deckcode.EnsureDeckCodeHQ(deckCode, req.MainFaction)
	cardBack := req.CardBack
	if cardBack == "" {
		switch strings.ToLower(strings.TrimSpace(req.MainFaction)) {
		case "soviet":
			cardBack = "cardback_starter_soviet"
		case "britain":
			cardBack = "cardback_starter_britain"
		case "germany":
			cardBack = "cardback_starter_german"
		case "japan":
			cardBack = "cardback_starter_japan"
		case "usa":
			cardBack = "cardback_starter_usa"
		default:
